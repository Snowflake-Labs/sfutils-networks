...
from sfutils_networks._toml_manifest import load_manifest, save_manifest
...
def run_sql(query: str, connection: str | None = None) -> list | None:
    ...
    default), keeping behaviour consistent with the rest of sfutils-networks.
    """
